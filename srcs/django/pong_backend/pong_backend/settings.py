...
SECRET_KEY = 'django-insecure-^u)zi^snwt9980*bd*@u^+5y^6mrw$winc3m++cq7bpbpq6b(u'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'pong.42.fr', '.pong.42.fr']
...
# Ensures Django knows it's behind a proxy
...
SESSION_COOKIE_HTTPONLY = True  # HTTPOnly flag for the session cookie
